...
public class QSCustomizer extends LinearLayout implements OnMenuItemClickListener {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_columns_three:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.QS_LAYOUT_COLUMNS_PORTRAIT, 3, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_four:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.QS_LAYOUT_COLUMNS_PORTRAIT, 4, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_five:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.QS_LAYOUT_COLUMNS_PORTRAIT, 5, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_six:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.QS_LAYOUT_COLUMNS_PORTRAIT, 6, UserHandle.USER_CURRENT);
                break;
    ...
    private void reset() {
        ...
        Settings.System.putIntForUser(mContext.getContentResolver(),
                Settings.System.QS_LAYOUT_COLUMNS_PORTRAIT, mDefaultColumns,
    ...
    public void updateSettings() {
        ...
        int columns = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.QS_LAYOUT_COLUMNS_PORTRAIT, mDefaultColumns,
                UserHandle.USER_CURRENT);
