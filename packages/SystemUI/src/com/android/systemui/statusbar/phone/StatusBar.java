...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public void start() {
        ...
        mVanillaSettingsObserver.observe();
        mVanillaSettingsObserver.update();
    ...
    private VanillaSettingsObserver mVanillaSettingsObserver = new VanillaSettingsObserver(mHandler);
    private class VanillaSettingsObserver extends ContentObserver {
        VanillaSettingsObserver(Handler handler) {
            super(handler);
        }
